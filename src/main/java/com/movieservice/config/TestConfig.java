...
public class TestConfig implements CommandLineRunner,WebMvcConfigurer {
    ...
    @Autowired
    private ProductItemRepository movieItemRepository;
    ...
    public void run(String... args) throws Exception {
        ...
        Product m1 = new Product(null,"O homem Aranha 3","relacionamento entre Peter Parker e M.J." +
        ...
        Product m2 = new Product(null,"A era do Gelo","Vinte mil anos atrás, num mundo coberto de gelo," +
        ...
        Product m3 = new Product(null,"1917","Na Primeira Guerra Mundial, dois soldados" +
        ...
        Product m4 = new Product(null,"Sonic","Sonic, o porco-espinho azul mais famoso do mundo," +
                ...
                "sonic.jpg",9.90);
        Product m5 = new Product(null,"Espetacular Homem Aranha","Peter Parker está tentando saber mais sobre" +
        ...
        Product m6 = new Product(null,"Homem de Ferro","Tony Stark é um industrial bilionário e inventor brilhante " +
        ...
        Product m7 = new Product(null,"Como eu Era Antes de Você","A jovem e peculiar Louisa \"Lou\" Clark transita de emprego a emprego " +
        ...
        Product m8 = new Product(null,"Os Croods","Família da pré-história vê sua caverna ser destruída. Depois disso, os Croods partem em uma" +
        ...
        ProductItem mi1 = new ProductItem(order, m1, 1, m1.getRent_price());
        ProductItem mi2 = new ProductItem(order, m2, 1, m2.getRent_price());
        ProductItem mi3 = new ProductItem(order2, m1, 1, m1.getRent_price());
        ProductItem mi4 = new ProductItem(order2, m2, 1, m2.getRent_price());
